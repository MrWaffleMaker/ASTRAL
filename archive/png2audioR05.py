...
def polar_image_to_hsv(file_name, duration, hop_size, frame_size=1024, sample_rate=48000):
...
def png2audio(input_file,output_file='polar_spectrogram.png',duration=30, sample_rate=48000,frame_size=1024):
...
if __name__ == "__main__":
    png2audio('pizzaspec.png','pizzaouttest.wav')
